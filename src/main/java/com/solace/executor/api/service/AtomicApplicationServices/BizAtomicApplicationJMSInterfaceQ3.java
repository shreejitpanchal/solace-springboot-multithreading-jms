...
@Service
public class BizAtomicApplicationJMSInterfaceQ3 {
    Logger logger = LoggerFactory.getLogger(BizAtomicApplicationJMSInterfaceQ3.class);
    @Autowired
    ...
    public CompletableFuture<AtomicAppAPIReqResp> sendEvent(String msg)  throws InterruptedException  {
        logger.info("- SENDING MESSAGE APP Q3 - " + Thread.currentThread().getName());
